...
function slugPress()
{
	...
	$(document).ready(function(){
		...
		/* SEO */
		seoChange();
		$('body').on("keyup",".title-seo, .keywords-seo, .description-seo, .focus-keyword-seo",function(){
			seoCount($(this));
		})
		...
		$("#filer-gallery").filer({
			limit: null,
			maxSize: null,
			extensions: ["jpg","png","jpeg","webp","JPG","PNG","JPEG","Png","Webp"],
...
$("#filer-import").filer({
	limit: null,
	maxSize: null,
	extensions: ["jpg","png","jpeg","webpp","JPG","PNG","JPEG","Png","Webp"],
