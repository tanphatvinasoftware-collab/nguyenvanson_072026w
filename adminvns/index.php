...
$ProgressImage = new ProgressImage($d);
...
<head>
	...
	<link href="assets/css/adminlte-login.css" rel="stylesheet">
	
	<link href="assets/css/adminlte-custom.css" rel="stylesheet">
...
<body class="sidebar-mini hold-transition text-sm <?=(!isset($_SESSION[$login_admin]['active']) || $_SESSION[$login_admin]['active']==false)?'login-page':''?>">
	<?php if($template == 'user/login') include TEMPLATE.LAYOUT."loader.php"; ?>
	<!-- Wrapper -->
	<?php if(isset($_SESSION[$login_admin]['active']) && ($_SESSION[$login_admin]['active'] == true)) { ?>
		<div class="wrapper">
			...
			include TEMPLATE.LAYOUT."toggle.php";
			?>
