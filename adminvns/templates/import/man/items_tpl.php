...
<section class="content">
	<?php if(isset($config['import']['images']) && $config['import']['images'] == true) { ?>
		<form method="post" action="<?=$linkUploadImg?>" enctype="multipart/form-data">
			<div class="card card-vns card-vns-detail card-primary card-outline text-sm mb-0">
				...
				<div class="card-body">
					...
					<label class="text-danger mt-2">Cách 2:</label>
			...
			<div class="card-fluid-vns">
				<div class="card-footer card-footer-detail-vns text-sm">
							...
							<?php for($i=0;$i<count($items);$i++) { ?>
								<tr>
									...
									<td class="align-middle text-center text-md text-nowrap">
										<a class="action-icon bg-action-1" href="<?=$linkEditImg?>&id=<?=$items[$i]['id']?>" title="Chỉnh sửa"><span class="action-icon-vns"><img src="assets/images/icon_edit.png"></span></a>
										<a class="action-icon bg-action-2 mr-0" id="delete-item" data-url="<?=$linkDeleteImg?>&id=<?=$items[$i]['id']?>" title="Xóa"><span class="action-icon-vns"><img src="assets/images/icon_delete.png"></span></a>
									</td>
								</tr>
							<?php } ?>
						</tbody>
		...
		<div class="card card-vns card-outline text-sm mb-0">
			...
			<div class="card-body">
				<div class="form-group">
					...
					<label class="change-file d-inline-block align-middle mb-1 mr-2" for="file-excel">
						<p>Upload tập tin:</p>
						<strong class="ml-2">
