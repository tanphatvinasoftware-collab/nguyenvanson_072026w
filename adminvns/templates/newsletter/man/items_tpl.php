    ...
    <div class="card-footer text-sm sticky-top">
        <div class="flex-btn-top">
            ...
            <div class="flex-btn-vns">
             ...
             <a class="btn btn-sm text-white bg-btn2" id="delete-all" data-url="<?=$linkDelete?>" title="Xóa tất cả"><i class="far fa-trash-alt mr-2"></i>Xóa tất cả</a>
         </div>
     </div>
 </div>
 <div class="card card-vns text-sm mb-0">
    <div class="card-header-vns flex-wrap">
...
<?php } ?>
<?php if(isset($config['newsletter'][$type]['guiemail']) && $config['newsletter'][$type]['guiemail'] == true) { ?>
    <div class="card card-vns card-vns-detail card-primary text-sm mb-0 <?=(!$paging)?'mt-3':'';?>">
        <div class="card-article">
            <form name="frmsendemail" method="post" action="<?=$linkMan?>" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <label class="change-file d-inline-block align-middle mb-1 mr-2" for="file">
                           <p>Upload tập tin:</p>
                           <strong class="ml-2">
