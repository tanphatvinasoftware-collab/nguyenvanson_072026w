					...
					<tbody>
						...
						<?php if(
							...
							<tr>
								...
								<td colspan="1" class="cast-money-cart-detail text-right"><?=$func->format_money($item['tamtinh'])?></td>
							</tr>
						<?php } ?>
						<?php if(isset($config['order']['ship']) && $config['order']['ship'] == true) { ?>
							<tr>
						...
						<tr>
							...
							<td colspan="1" class="cast-money-cart-detail text-right"><?=$func->format_money($item['tonggia'])?></td>
						</tr>
					</tbody>
				<?php } ?>
			</table>
