    ...
    <?php } else { ?>
      <tbody>
        <?php for($i=0;$i<count($items);$i++) {
         ...
         if(!empty($items[$i]['id_sub'])) $linkID .= "&id_sub=".$items[$i]['id_sub'];
         if(!empty($items[$i]['id_brand'])) $linkID .= "&id_brand=".$items[$i]['id_brand']; 
         if(!empty($items[$i]['id_huong'])) $linkID .= "&id_huong=".$items[$i]['id_huong'];
         if(!empty($items[$i]['id_tygia'])) $linkID .= "&id_tygia=".$items[$i]['id_tygia'];
         if(!empty($items[$i]['id_tinhthanh'])) $linkID .= "&id_tinhthanh=".$items[$i]['id_tinhthanh'];
         ?>
         <tr>
