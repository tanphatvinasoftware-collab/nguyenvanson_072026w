<?php
	class AddonsOnline
	{
		...
		public function setScript($element='', $type='', $scrolltop=1)
		{
			...
			if($element && $type)
			{
				$script = '<script type="text/javascript">$(function(){var a=!1;$(window).scroll(function(){$(window).scrollTop()>'.$scrolltop.' && !a&&(setTimeout(function(){ $("#'.$element.'").load("ajax/ajax_addons.php?type='.$type.'") }, 2000),a=!0)})});</script>';
