...
define("goichungtoi","Gọi cho chúng tôi");
define("guithacmacchochungtoi","Gửi thắc mắc cho chúng tôi");
define("thongtinve","Thông tin về");
define("thongtindangkytaikhoan","Thông tin đăng ký tài khoản");
define("tentaikhoan","Tên tài khoản");
define("bandacotaikhoan","Bạn đã có tài khoản?");
define("hoacdangnhapbang","Hoặc đăng nhập bằng");
define("cacdacquyen","Các đặc quyền khi đăng ký tài khoản");
define("dichvukhachhang","Dịch vụ khách hàng");
define("bancangiupdo","Bạn cần giúp đỡ? Xin hãy gọi điện đến Hotline ");
define("khachhangdangkymoi","Khách hàng đăng ký mới");
