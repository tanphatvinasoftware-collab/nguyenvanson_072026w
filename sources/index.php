...
$tintucnb = $d->rawQuery("select ten$lang as ten, tenkhongdauvi, tenkhongdauen, mota$lang as mota, ngaytao, id, photo from #_news where type = ? and noibat > 0 and hienthi > 0 order by stt,id desc limit 0 ,2", array('kien-thuc'));
...
$video = $d->rawQueryOne("select photo,link_video from #_photo where type = ? and act = ? and hienthi > 0 limit 0,1", array('video', 'photo_static'));
