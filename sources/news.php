...
if($id!='')
{
	...
	if($news_list) $breadcr->setBreadCrumbs($news_list[$sluglang],$news_list['ten']);
	if($news_cat) $breadcr->setBreadCrumbs($news_cat[$sluglang],$news_cat['ten']);
	if($news_item) $breadcr->setBreadCrumbs($news_item[$sluglang],$news_item['ten']);
	if($news_sub) $breadcr->setBreadCrumbs($news_sub[$sluglang],$news_sub['ten']);
	if($row_detail) $breadcr->setBreadCrumbs($row_detail[$sluglang],$row_detail['ten']);
