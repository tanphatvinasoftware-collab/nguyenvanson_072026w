	...
	<div class="center d-flex flex-wrap justify-content-between">
		...
		<div class="intro-right">
			<div class="intro-image">
				<img onerror="this.src='<?=$func->addWebpToUrl(THUMBS.'/416x416x2/assets/images/noimage.png')?>';" src="<?= $func->addWebpToUrl(THUMBS.'/416x416x1/'.UPLOAD_NEWS_L.$gioithieu['photo2'],'416x416x1');?>" alt="<?=$gioithieu['ten']?>" 	loading="lazy">
			</div>
			<div class="intro-image">
			<img onerror="this.src='<?=$func->addWebpToUrl(THUMBS.'/298x298x2/assets/images/noimage.png')?>';" src="<?= $func->addWebpToUrl(THUMBS.'/298x298x1/'.UPLOAD_NEWS_L.$gioithieu['photo'],'298x298x1');?>" alt="<?=$gioithieu['ten']?>" 	loading="lazy">
			</div>
		</div>
	</div>
</div>
